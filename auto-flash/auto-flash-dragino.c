    ...
    while(1) {
        ...
        if (c>0) {
            if (c>=' ')
                ...
                if (!strcmp(line,"Hit any key to stop autoboot:  4 ")) {
                    ...
                    if (!ignore_uboot) {
                        ...
                        {
                            int i;
                            char *s="\r\ntftp 82000000 openwrt-dragino; erase 0x9f050000 +$filesize; cp.b 0x82000000 0x9f050000 $filesize; setenv bootcmd bootm 0x9f050000; saveenv\r\n";
                            for(i=0;s[i];i++) {
